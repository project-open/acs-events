...
--
	...
	--
create or replace function time_interval__new (timestamptz,timestamptz ) 
returns integer as $$
declare
...
begin
	...
	--
create or replace function time_interval__delete (integer)
returns integer as $$
declare
...
create or replace function timespan__new (integer,boolean)
returns integer as $$
declare
...
begin
	...
	insert into timespans (timespan_id, interval_id)
